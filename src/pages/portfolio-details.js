...
import imgWorkCover from "../assets/image/png/apps/cookitapp-3.png";
import imgS1 from "../assets/image/png/apps/cookitapp-2.png";
import imgS2 from "../assets/image/png/apps/cookitapp-1.png";
// import imgS3 from "../assets/image/png/apps/cookitapp-2.png";
import imgS4 from "../assets/image/png/apps/cookitapp.png";
    ...
    <>
      <PageWrapper>
        <Container
          ...
          `}
        >
          <img src={imgWorkCover} alt="" className="img-fluid w-80" />
        </Container>
          ...
          <Container>
            <Row>
              <Col lg="8">
                ...
                Save your recipes in a concise and mobile friendly way.{" "}
                </Title>
                <Text
                  variant="p"
                  css={`
                  ...
                  `}
                >
                  Do you ever need to compile a list of recipes from different websites into your own mini organizer? 
        ...
        <div className="mt-lg-3">
          <Container>
            <Row>
              ...
              <Col lg="4">
                <Button arrowRight><a target="_blank" href="https://cookitapp1.herokuapp.com/">Live work</a></Button>
              </Col>
            </Row>
          </Container>
        </div>
